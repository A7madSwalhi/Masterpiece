...
@section("pagetitle","All Processing Orders")

@section("title","All Processing Orders")

@section('breadcrumb')
    @parent

    <li class="breadcrumb-item active" aria-current="page">All Processing Orders<span class="badge rounded-pill bg-danger ms-1">{{ count($orders) }}</span> </li>
@endsection
