...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">All Orders<span class="badge rounded-pill bg-danger ms-1">{{ count($orders) }}</span> </li>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="mt-3">
                        <form action="{{ URL::current() }}" method="get" class="d-flex justify-content-between mb-4">
                            ...
                            <x-form.select name="payment_method" first="Payment Type" :selected="request('payment_method')" :options="['cod' =>'Cash On Delivery'  , 'stripe' => 'Stripe']" class="mx-2"/>
                            <x-form.select name="status" first="Status" :selected="request('status')" :options="['pending' =>'Pending'  , 'completed' => 'Completed', 'processing'=>'Processing' , 'delivering'=>'Delivering','cancelled'=>'Cancelled']"/>
                        ...
                        <table id="example" class="table table-striped table-bordered dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a href="{{ route('vendor.orders.show',$order->id) }}" class="btn btn-primary ">
