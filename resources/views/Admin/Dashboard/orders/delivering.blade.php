...
@section("pagetitle","All Delivering Orders")

@section("title","All Delivering Orders")

@section('breadcrumb')
    @parent

    <li class="breadcrumb-item active" aria-current="page">All Delivering Orders<span class="badge rounded-pill bg-danger ms-1">{{ count($orders) }}</span> </li>
@endsection
