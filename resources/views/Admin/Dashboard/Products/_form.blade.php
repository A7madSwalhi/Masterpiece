            ...
            <div class="col-lg-4">
                <div class="border border-3 p-4 rounded">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <x-form.label id="vendor_id" class="form-label">Select Vendor</x-form.label>
                            ...
                            <x-form.select name="vendor_id" id="vendor_id" :options="$vendors" :selected="$product->vendor_id"/>
                        </div>
