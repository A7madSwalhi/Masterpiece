...
@section("pagetitle","All Completed Orders")
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">All Completed Orders<span class="badge rounded-pill bg-danger ms-1">{{ count($orders) }}</span> </li>
@endsection
