...
class ProductsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("store.Dashboard.Products.index",compact('products'));
    }
    ...
    public function create()
    {
        ...
        // dd($category);
        return view("store.Dashboard.Products.create",compact('product','vendors','brands','categories','gallary'));
    }
    ...
    public function edit($id)
    {
        ...
        if($product->options){
            ...
            // dd($colors,$sizes);
            return view("store.Dashboard.Products.edit",compact('product','vendors','brands','categories','tags','gallary','sizes','colors'));

        }else{


            return view("store.Dashboard.Products.edit",compact('product','vendors','brands','categories','tags','gallary'));
        }
    ...
    public function toggleFeature(Request $request, $id)
    {
        ...
        return redirect()->route('vendor.products.index')->with('success', 'Product featured status updated!');
    }
}
