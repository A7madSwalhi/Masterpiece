			...
			<ul class="metismenu" id="menu">
                ...
                <li>
					...
					<ul>
						<li> <a href="{{route('admin.categories.index')}}"><i class="bx bx-right-arrow-alt"></i>All Category</a>
						</li>
						<li> <a href="{{route("admin.categories.create")}}"><i class="bx bx-right-arrow-alt"></i>Add Category</a>
						</li>
					</ul>
				</li>
