...
@section('addbutton')
    <a href="{{route("vendor.products.create")}}" class="btn btn-success">Add Products</a>
@endsection
                        ...
                        <table id="example" class="table table-striped table-bordered dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <a href="{{route("vendor.products.show",$product->id)}}" class="btn btn-primary ">
                                                <i class="bx bx-show me-0"></i>
                                        </a>
                                        <a href="{{route("vendor.products.edit",$product->id)}}" class="btn btn-info ">
                                        ...
                                        <form action="{{ route('vendor.products.feature', $product->id) }}" method="POST" style="display: none;" id="feature-form-{{ $product->id }}">
                                            @csrf
                                            @method('PATCH')
